      ...
      <Flex flexDirection="column" position="relative" top="70px">
        ...
        >
          ...
          >
            ...
            >
              ...
              <br />
              alcançar solução de um grave problema: O descarte inconciente de
              <br />
            ...
            <HStack flexWrap="wrap" justifyContent="center" gap={4} mb="30px">
              ...
              <Center flexDirection="column" marginY={10} width="250px">
                ...
                <Text textStyle="headline">Scrum Master</Text>
              </Center>
              <Center flexDirection="column" marginY={10} width="250px">
        ...
        >
          ...
          >
            ...
            >
              <br />
              Se você tem interesse em comprar o óleo faça seu cadastro como
            ...
            <Text
              ...
              fontFamily="body"
            >
              Se você tem interesse em disponibilizar o seu óleo faça o cadastro
              <br />
